...
public class MensajeDao {
    ...
    public List<Mensaje> findByEmisorAndTipo(Long emisorId, String tipo) {
        String sql = "SELECT id, emisor_id, receptor_id, tipo_mensaje, contenido, archivo_id, creado_en FROM mensajes WHERE emisor_id = ? AND tipo_mensaje = ? ORDER BY creado_en DESC LIMIT 500";
    ...
    public Mensaje findById(Long id) {
        String sql = "SELECT id, emisor_id, receptor_id, tipo_mensaje, contenido, archivo_id, creado_en FROM mensajes WHERE id = ?";
